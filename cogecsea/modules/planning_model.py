...
class Planning_Sequential(nn.Module):
    def __init__(self,outline_model, text_model):
        super().__init__()
    ...
    def forward (
        ...
        text_outputs= self.text_model(input_ids=concat_inputs, decoder_input_ids=decoder_input_ids['ful_answer_ids'], labels=labels['full_answer_labels'])
